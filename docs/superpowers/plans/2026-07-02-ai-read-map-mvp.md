...
export default defineManifest({
  ...
  // so this doesn't violate the manual-trigger constraint. Spec §18
  // explicitly sanctions broader permissions for the early/private-test
  // phase this MVP targets ("production should keep permissions as narrow
  // as possible"). Narrow to activeTab + chrome.scripting.executeScript
